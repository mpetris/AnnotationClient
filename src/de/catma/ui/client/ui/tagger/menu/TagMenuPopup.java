...
class TagMenuPopup extends PopupPanel {
		...
		public TagMenuPopup(EventListener listener) {
			super(true);
		...
		public void addTag(final String tagName, final String tagID) {
...
//			hPanel.setStylePrimaryName("tagger_menu_item");
			...
			Label l = new Label(tagName + " #" + tagID);
			...
			HandlerRegistration handlerRegistration = tagRemoveButton.addClickHandler(new ClickHandler() {
				...
				public void onClick(ClickEvent event) {
					eventlistenerSupport.fireEvent(tagID);
				}
			});
